  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
        <h3 className="text-xl font-semibold text-white mb-6">Text Editor (Snapshot)</h3>
        ...
        <div className="flex gap-4">
           ...
           <button onClick={undo} disabled={historyCount === 0} className="flex-1 py-3 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 rounded text-white flex items-center justify-center gap-2">
             <RotateCcw size={18} /> Undo ({historyCount})
           </button>
        </div>
      </div>
      ...
      <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 flex flex-col items-center justify-center">
         ...
         <div className="text-gray-400 text-center">
           <p className="mb-2">Snapshots stored in Memento objects.</p>
           <p className="text-xs text-gray-600">The "Caretaker" (HistoryManager) holds the stack but never modifies the contents.</p>
         </div>
