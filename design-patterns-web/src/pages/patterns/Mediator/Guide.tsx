    ...
    <div className="space-y-8 max-w-3xl">
      <section>
        ...
        <div className="text-gray-700 dark:text-gray-300">
          <MarkdownTrans i18nKey="mediator.concept.definition" />
        </div>
        <div className="text-gray-700 dark:text-gray-300 mt-2">
          <MarkdownTrans i18nKey="mediator.concept.analogy" />
        </div>
      </section>
  ...
  send(msg) { this.mediator.notify(this, msg); }
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
          <li>{t('mediator.usage.point1')}</li>
          <li>{t('mediator.usage.point2')}</li>
          <li>{t('mediator.usage.point3')}</li>
        </ul>
      </section>
    </div>
  );
