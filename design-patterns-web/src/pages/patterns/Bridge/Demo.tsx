  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 flex flex-col items-center">
        ...
        <div className="w-48 bg-gray-950 rounded-3xl p-6 border-4 border-gray-700 shadow-2xl flex flex-col gap-6">
           <button 
             onClick={togglePower}
             className="w-12 h-12 bg-red-600 hover:bg-red-500 rounded-full text-white mx-auto flex items-center justify-center shadow-lg active:scale-95 transition-all"
           >
             <Power size={20} />
           </button>

           <div className="flex justify-between items-center bg-gray-800 rounded-full p-2">
              <button onClick={volumeDown} className="w-10 h-10 bg-gray-700 rounded-full text-white hover:bg-gray-600">-</button>
              <Volume2 size={16} className="text-gray-400" />
              <button onClick={volumeUp} className="w-10 h-10 bg-gray-700 rounded-full text-white hover:bg-gray-600">+</button>
           </div>
        </div>
      </div>

      {/* Devices (Implementation) */}
      <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 flex flex-col gap-6">
        {/* TV */}
        <div className={clsx("p-6 rounded-xl border transition-all duration-500", tv.isOn ? "bg-gray-800 border-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.2)]" : "bg-black border-gray-800 opacity-50")}>
        ...
        {/* Radio */}
        <div className={clsx("p-6 rounded-xl border transition-all duration-500", radio.isOn ? "bg-gray-800 border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.2)]" : "bg-black border-gray-800 opacity-50")}>
           <div className="flex justify-between items-start mb-4">
             <div className="flex items-center gap-3">
