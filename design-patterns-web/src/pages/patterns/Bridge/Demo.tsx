  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800 flex flex-col gap-6">
        {/* TV */}
        <div className={clsx("p-6 rounded-xl border transition-all duration-500", tv.isOn ? "bg-white dark:bg-gray-800 border-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.2)]" : "bg-gray-100 dark:bg-black border-gray-200 dark:border-gray-800 opacity-50")}>
           <div className="flex justify-between items-start mb-4">
             <div className="flex items-center gap-3">
               <Tv size={32} className={tv.isOn ? "text-blue-400" : "text-gray-500 dark:text-gray-400"} />
        ...
        {/* Radio */}
        <div className={clsx("p-6 rounded-xl border transition-all duration-500", radio.isOn ? "bg-white dark:bg-gray-800 border-orange-500 shadow-[0_0_20px_rgba(249,115,22,0.2)]" : "bg-gray-100 dark:bg-black border-gray-200 dark:border-gray-800 opacity-50")}>
           <div className="flex justify-between items-start mb-4">
             <div className="flex items-center gap-3">
               <Speaker size={32} className={radio.isOn ? "text-orange-400" : "text-gray-500 dark:text-gray-400"} />
