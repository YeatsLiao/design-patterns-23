...
const FileSystemNode = ({ item, level = 0, onCalculateSize }: { item: FileSystemItem; level?: number; onCalculateSize: (size: number) => void }) => {
  ...
  return (
    <div className="select-none">
      <div 
        className={clsx(
           "flex items-center gap-2 py-1 px-2 hover:bg-gray-800 rounded cursor-pointer transition-colors",
      ...
      >
        ...
        {item.type === 'folder' ? <Folder size={16} className="text-blue-500" /> : <File size={16} className="text-gray-400" />}
