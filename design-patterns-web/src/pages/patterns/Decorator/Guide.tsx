    ...
    <div className="space-y-8 max-w-3xl">
      <section>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          <MarkdownTrans i18nKey="decorator.concept.definition" />
        </p>
        <p className="text-gray-700 dark:text-gray-300 mt-2">
          <MarkdownTrans i18nKey="decorator.concept.analogy" />
        </p>
      </section>
...
myCoffee = new MilkDecorator(myCoffee); // cost is 2.5`}
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
          <li>{t('decorator.usage.point1')}</li>
          <li>{t('decorator.usage.point2')}</li>
        </ul>
      </section>
    </div>
  );
