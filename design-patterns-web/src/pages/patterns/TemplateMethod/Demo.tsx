...
abstract class DataMiner {
  ...
  protected async closeFile(): Promise<string> {
    return "Common: Closing File handle.";
  }
}

// Concrete Class 1
class PDFMiner extends DataMiner {
  protected async openFile() { return "PDF: Opening PDF Viewer..."; }
  protected async extractData() { return "PDF: OCR Scanning text layers..."; }
  protected async parseData() { return "PDF: Converting raw text to JSON..."; }
}

// Concrete Class 2
class CSVMiner extends DataMiner {
  protected async openFile() { return "CSV: Opening File Stream..."; }
  protected async extractData() { return "CSV: Reading comma-separated lines..."; }
  protected async parseData() { return "CSV: Splitting columns to JSON..."; }
}
...
const TemplateMethodDemo = () => {
  ...
  const runMiner = async (type: 'pdf' | 'csv') => {
    ...
    const miner = type === 'pdf' ? new PDFMiner() : new CSVMiner();
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
        <h3 className="text-xl font-semibold text-white mb-6">Data Mining Pipeline</h3>
      ...
      <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 min-h-[400px]">
         <h4 className="text-gray-400 uppercase tracking-wider text-xs mb-4">Execution Steps</h4>
