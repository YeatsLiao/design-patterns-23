  ...
  return (
    <div className="space-y-12 pb-20">
      <div className="border-b border-gray-800 pb-6">
        <h1 className="text-4xl font-bold text-white mb-4">{t('patterns.chainOfResponsibility.title')}</h1>
        <p className="text-xl text-gray-400 max-w-3xl">{t('patterns.chainOfResponsibility.description')}</p>
      </div>
      <section>
